...
function isCppKeyword(word: string) {
...
export function isCppVariantName(name: string) {
...
export function isExGraphicsVariantName(name: string) {
    var cppVar = isCppVariantName(name);
    if (cppVar.result != true) return cppVar;
...
export function isColorString(input: string) { 
